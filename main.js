...
while (true) {
    ...
    switch (useResponse.operator) {
        case "Addition":
            console.log(`First Number: ${useResponse.firstNumber} ` +
                `Second Number: ${useResponse.secondNumber} ` +
                `\nResult: ${addition(useResponse.firstNumber, useResponse.secondNumber)}`);
            break;
        case "Subtraction":
            console.log(`First Number: ${useResponse.firstNumber} ` +
                `Second Number: ${useResponse.secondNumber} ` +
                `\nResult: ${subtraction(useResponse.firstNumber, useResponse.secondNumber)}`);
            break;
        case "Multiplication":
            console.log(`First Number: ${useResponse.firstNumber} ` +
                `Second Number: ${useResponse.secondNumber} ` +
                `\nResult: ${multiplication(useResponse.firstNumber, useResponse.secondNumber)}`);
            break;
        case "Division":
            console.log(`First Number: ${useResponse.firstNumber} ` +
                `Second Number: ${useResponse.secondNumber} `);
            if (useResponse.secondNumber === 0) {
                ...
                console.log(`\nResult: ${division(useResponse.firstNumber, useResponse.secondNumber)}`);
            }
            break;
        case "Percentage":
            console.log(`First Number: ${useResponse.firstNumber} ` +
                `Second Number: ${useResponse.secondNumber} ` +
                `\nResult: ${per(useResponse.firstNumber, useResponse.secondNumber)}`);
            break;
        default:
